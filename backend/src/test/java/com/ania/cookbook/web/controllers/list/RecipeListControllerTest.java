...
//
//    @Autowired
//    private ListService recipeManagementService;
//
//    @Autowired
//    private RecipeListEntryMapper entryMapper;
//
//    private ListRequest buildListRequestWithName() {
//        return ListRequest.builder().listName("").build();
//    }
//
//    private ListRequest buildAddRecipeRequest() {
//        return ListRequest.builder().recipeId(RECIPE_ID).portions(PORTIONS).build();
//    }
//
//    @Test
...
//        ListRequest request = buildListRequestWithName();
//        String json = objectMapper.writeValueAsString(request);
//
//        mockMvc.perform(post("/api/lists")
//                        .contentType(MediaType.APPLICATION_JSON)
...
//        ListRequest request = buildAddRecipeRequest();
//        String json = objectMapper.writeValueAsString(request);
//        ListEntryEntity entry = mock(ListEntryEntity.class);
//        Recipe recipe = Recipe.builder()
//                .recipeId(RECIPE_ID)
//                .recipeName("Test Recipe")
//                .build();
//        ReadRecipeResponse readRecipeResponse = ReadRecipeResponse.from(recipe);
//        ListEntryResponse response = ListEntryResponse.builder()
//                .entryId(ENTRY_ID)
//                .portions(PORTIONS)
...
//                .recipe(readRecipeResponse)
//                .build();
//        List<ListEntryResponse> entryResponses = List.of(entryResponse);
