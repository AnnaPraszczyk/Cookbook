...
class RecipeListEntryMapperTest {
    ...
    void setUp() {
        ...
        entryMapper = new RecipeListEntryMapper(recipeMapper);
    }
    ...
    void mapEntityToResponseCorrectly() {
        ...
        RecipeListEntryResponse result = entryMapper.toResponse(entry);
...
//    }
    ...
    void throwExceptionWhenRecipeIsNullToEntity() {
        ...
        assertThrows(RecipeValidationException.class, () -> RecipeListEntryDomain.builder()
                .entryId(UUID.randomUUID())
                .portions(2)
                .recipe(null)
                .savedRecipeList(savedListDomain)
    ...
    void throwExceptionWhenSavedRecipeListIsNullToEntity() {
        ...
        assertThrows(ListValidationException.class, () -> RecipeListEntryDomain.builder()
                .entryId(UUID.randomUUID())
                .portions(2)
                .recipe(recipe)
