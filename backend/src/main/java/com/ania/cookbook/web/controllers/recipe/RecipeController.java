...
public class RecipeController {
    ...
    @PutMapping("/{recipeId}")
    public ResponseEntity<RecipeResponse> updateRecipe(@PathVariable UUID recipeId, @Valid @RequestBody UpdateRecipeCase request) {
    ...
    public ResponseEntity<Void> deleteRecipe(@PathVariable UUID recipeId, @Valid @RequestBody DeleteRecipeCase request) {
